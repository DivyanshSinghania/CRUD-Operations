...
@Component({
  ...
  styles: [`
    .page-container {
      min-height: 100vh;
      padding: 2rem;
      background: #1d3a25; /* Changed from blue to dark green */
    }
    ...
    .btn-primary {
      background: #1d3a25; /* Dark green button */
      color: white;
    }

    .btn-primary:hover {
      transform: translateY(-2px);
      box-shadow: 0 8px 25px rgba(29, 58, 37, 0.4);
    }
    ...
    .form-control:focus {
      outline: none;
      border-color: #1d3a25; /* Dark green focus */
      box-shadow: 0 0 0 3px rgba(29, 58, 37, 0.1);
    }
